...
(cl:in-package active_vision_msgs-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <Vision_Message>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Vision_Message)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name active_vision_msgs-msg:<Vision_Message> is deprecated: use active_vision_msgs-msg:Vision_Message instead.")))

(cl:ensure-generic-function 'Frameid-val :lambda-list '(m))
(cl:defmethod Frameid-val ((m <Vision_Message>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader active_vision_msgs-msg:Frameid-val is deprecated.  Use active_vision_msgs-msg:Frameid instead.")
  (Frameid m))

(cl:ensure-generic-function 'Pos-val :lambda-list '(m))
(cl:defmethod Pos-val ((m <Vision_Message>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader active_vision_msgs-msg:Pos-val is deprecated.  Use active_vision_msgs-msg:Pos instead.")
  (Pos m))

(cl:ensure-generic-function 'Found-val :lambda-list '(m))
(cl:defmethod Found-val ((m <Vision_Message>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader active_vision_msgs-msg:Found-val is deprecated.  Use active_vision_msgs-msg:Found instead.")
  (Found m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Vision_Message>)))
  ...
  "active_vision_msgs/Vision_Message")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Vision_Message)))
  "Returns string type for a message object of type 'Vision_Message"
  "active_vision_msgs/Vision_Message")
