...
(cl:in-package active_perception-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <Vision_Service-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Vision_Service-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name active_perception-srv:<Vision_Service-request> is deprecated: use active_perception-srv:Vision_Service-request instead.")))

(cl:ensure-generic-function 'Label-val :lambda-list '(m))
(cl:defmethod Label-val ((m <Vision_Service-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader active_perception-srv:Label-val is deprecated.  Use active_perception-srv:Label instead.")
  (Label m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Vision_Service-request>)))
  ...
  "active_perception/Vision_ServiceRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Vision_Service-request)))
  "Returns string type for a service object of type 'Vision_Service-request"
  "active_perception/Vision_ServiceRequest")
...
(cl:defclass <Vision_Service-response> (roslisp-msg-protocol:ros-message)
  ((object_location
    ...
    :type active_perception-msg:Vision_Message
    :initform (cl:make-instance 'active_perception-msg:Vision_Message)))
)
...
(cl:defmethod cl:initialize-instance :after ((m <Vision_Service-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Vision_Service-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name active_perception-srv:<Vision_Service-response> is deprecated: use active_perception-srv:Vision_Service-response instead.")))

(cl:ensure-generic-function 'object_location-val :lambda-list '(m))
(cl:defmethod object_location-val ((m <Vision_Service-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader active_perception-srv:object_location-val is deprecated.  Use active_perception-srv:object_location instead.")
  (object_location m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Vision_Service-response>)))
  ...
  "active_perception/Vision_ServiceResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Vision_Service-response)))
  "Returns string type for a service object of type 'Vision_Service-response"
  "active_perception/Vision_ServiceResponse")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Vision_Service-response>)))
  ...
  (cl:format cl:nil "Vision_Message object_location~%~%~%================================================================================~%MSG: active_perception/Vision_Message~%string Frameid~%geometry_msgs/Point32 Pos~%bool Found~%~%================================================================================~%MSG: geometry_msgs/Point32~%# This contains the position of a point in free space(with 32 bits of precision).~%# It is recommeded to use Point wherever possible instead of Point32.  ~%# ~%# This recommendation is to promote interoperability.  ~%#~%# This message is designed to take up less space when sending~%# lots of points at once, as in the case of a PointCloud.  ~%~%float32 x~%float32 y~%float32 z~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Vision_Service-response)))
  "Returns full string definition for message of type 'Vision_Service-response"
  (cl:format cl:nil "Vision_Message object_location~%~%~%================================================================================~%MSG: active_perception/Vision_Message~%string Frameid~%geometry_msgs/Point32 Pos~%bool Found~%~%================================================================================~%MSG: geometry_msgs/Point32~%# This contains the position of a point in free space(with 32 bits of precision).~%# It is recommeded to use Point wherever possible instead of Point32.  ~%# ~%# This recommendation is to promote interoperability.  ~%#~%# This message is designed to take up less space when sending~%# lots of points at once, as in the case of a PointCloud.  ~%~%float32 x~%float32 y~%float32 z~%~%"))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Vision_Service)))
  ...
  "active_perception/Vision_Service")